...
ob_start();
	...
	{
                if(isset($_GET["pid"])){
				 $a = "update tbl_request set  request_status='4', request_amount='".$_GET['amt']."' where request_id='".$_GET["pid"]."'";
                }
                else{
				 $a = "update tbl_request set  payment_status='1', request_amount='".$_GET['amt']."' where request_id='".$_GET["aid"]."'";
