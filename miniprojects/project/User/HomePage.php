                 ...
                 <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav mr-auto">
                     ...
                     <!--<li class="nav-item dropdown">
                          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"> <i class="fa fa-angle-down"></i></a>
                      ...
                      <<li class="nav-item">
    <a href="../User/MyProfile.php" class="nav-link">MY PROFILE</a>
</li>
              
                      <li class="nav-item">
    <a href="../User/ViewRentItem.php" class="nav-link">RENT EQUIPMENTS</a>
</li>
        
                      
<<li class="nav-item">
    <a href="../User/Request.php" class="nav-link">REQUEST</a>
</li>
<li class="nav-item">
    <a href="../User/MyRequest.php" class="nav-link">MY REQUEST</a>
</li>
<li class="nav-item">
    <a href="../User/Complaint.php" class="nav-link">FEEDBACK</a>
</li>
<li class="nav-item">
    <a href="/miniproject/project/Logout.php" class="nav-link">LOGOUT</a>
</li>
        ...
        <div class="row align-items-center">
          ...
          <div class="col-md-4 text-center text-md-right mt-3 mt-md-0">
              <div class="call-to-action-btn">
                <a class="btn btn-dark" href="/miniproject/project/User/Request.php">Request Tools</a>
              </div>
          </div><!-- col end -->
        </div><!-- row end -->
    ...
    <div class="row">
        <div class="col-lg-6">
          <div class="ts-intro">
              ...
              <h3 class="into-sub-title">We deliver Quality Tools
              </h3>
              <p>We provide top-quality construction equipment to help you bring your projects to life.Whether you're a contractor or a DIY enthusiast 
                ,our range of heavy-duty tools is designed to meet your toughest challenges.With a focus on reliability and convenience ,we make it easy to rent 
                the right machinery for your needs,so you can focus on building uour dream's.
              </p>
          </div><!-- Intro box end -->
        ...
        <div class="col-lg-6 mt-4 mt-lg-0">
          ...
          <p>We are commited to providing high-quality tools and equipments that ensure safety and efficiency for every project.</p>
...
<script>
  document.addEventListener('DOMContentLoaded', function() {
    // Fetch overdue data from backend
    fetch('checkDue.php')
        .then(response => response.json())
        .then(data => {
            if (data.length > 0) {
                // If there are overdue requests, show modal
                showOverdueModal(data.length);
            }
        });

    // Function to show modal
    function showOverdueModal(overdueCount) {
        const modal = document.getElementById('overdueModal');
        const modalMessage = document.getElementById('modalMessage');
        
        modalMessage.innerHTML = `The return date for your rental has passed. Additional charges will apply for each day until the product is returned.`;
