            ...
            <div class="col-lg-9 header-right">
                <ul class="top-info-box">
                 ...
                 <li class="header-get-a-quote">
                    <a class="btn btn-primary" href="/miniproject/project/Shop/MyProfile.php">PROFILE</a> 
                  </li> 
                </ul><!-- Ul end -->
                 ...
                 <div id="navbar-collapse" class="collapse navbar-collapse">
                    <ul class="nav navbar-nav mr-auto">
                     <!-- <li class="nav-item dropdown active">
                      ...
                      <li class="nav-item dropdown">
                          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Rent Equiments <i class="fa fa-angle-down"></i></a>
                          <ul class="dropdown-menu" role="menu">
                            <li><a href="/miniproject/project/User/ViewRentItem.php">All equipments</a></li>
