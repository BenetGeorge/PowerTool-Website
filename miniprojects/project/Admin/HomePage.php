...
<body>
<h1 align="left"><div align="center">Welcome <?php echo $_SESSION['uname']?></h1>
  ...
  <table width="200" border="1">
    ...
    <tr>
      <td><a href="ShopVerification.php">ShopVerification</a></td>
    </tr>
    <tr>
        ...
        <div class="sidebar-wrapper scrollbar scrollbar-inner">
          <div class="sidebar-content">
            <ul class="nav nav-secondary">
              ...
              <li class="nav-item">
                <a href="/miniproject/project/Admin/Category.php">
                  <i class="fas fa-desktop"></i>
                  <p>Category</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/miniproject/project/Admin/Subcategory.php">
                  <i class="fas fa-desktop"></i>
                  <p>Subcategory</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/miniproject/project/Admin/Shopverification.php">
                  <i class="fas fa-desktop"></i>
                  <p>Shop Verification</p>
                </a>
              </li> 
              
              
              <li class="nav-item">
                <a href="/miniproject/project/Admin/District.php">
                  <i class="fas fa-desktop"></i>
                  <p>District</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/miniproject/project/Admin/Place.php">
                  <i class="fas fa-desktop"></i>
                  <p>Place</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/miniproject/project/Admin/UserList.php">
                  <i class="fas fa-desktop"></i>
                  <p>UserList</p>
                </a>
              </li> 
              <li class="nav-item">
                <a href="/miniproject/project/Admin/ViewComplaint.php">
                  <i class="fas fa-desktop"></i>
                  <p>ViewComplaint</p>
                </a>
              </li> 
